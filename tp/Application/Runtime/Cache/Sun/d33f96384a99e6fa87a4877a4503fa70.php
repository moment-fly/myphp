...
<?php endif; ?>
		...
		<div class="table-responsive">
			...
			<?php if(is_array($result_data)): $i = 0; $__LIST__ = $result_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php echo ($vo["personcode"]); ?></td>
				<td><?php echo ($vo["created"]); ?></td>
						<td>
							<div class="btn-group" role="group" aria-label="...">
								<a class="btn btn-primary" href="/Sun/Score/user_scores?id=<?php echo ($vo["id"]); ?>&username=<?php echo ($vo["username"]); ?>">
									 成绩
								</a>
								<?php if($vo['status']==2):?>
									<a href="javascript:void(0);" class="btn btn-warning change-status" data-id=<?php echo ($vo["id"]); ?> data-status="1">
										 禁用
									</a>
								<?php else: ?>
									<a href="javascript:void(0);" class="btn btn-warning change-status" data-id=<?php echo ($vo["id"]); ?> data-status="2">
										 启用
									</a>
								<?php endif;?>
								<a class="btn btn-warning" href="/Sun/User/edit_user?id=<?php echo ($vo["id"]); ?>">
									 修改
								</a> 
								<a href="/Sun/User/delete_user?id=<?php echo ($vo["id"]); ?>"  class="btn btn-danger delete-user" >
									 删除
								</a>
							</div>
						</td>
