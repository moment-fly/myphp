...
<html lang="zh-CN">
	<head>
		...
		<!-- Bootstrap -->
		<link href="/PHP/assets/css/bootstrap.min.css" rel="stylesheet">
	...
	<body>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li class="<?php if ('User' == $controller): ?>active<?php endif; ?> dropdown">
							...
							<ul class="dropdown-menu">
								<li <?php if ('User' == $_SESSION['controller'] && 'user_list' == $_SESSION['action']): ?> class="active" <?php endif; ?>><a href="/PHP/User/user_list">用户列表</a></li>
								<li <?php if ('User' == $_SESSION['controller'] && 'add_user' == $_SESSION['action']): ?> class="active" <?php endif; ?>><a href="/PHP/User/add_user">增加用户</a></li>
							</ul>
						</li>
					</ul>
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="/PHP/User/home_page">个人首页</a></li>
								<li><a href="/PHP/index.php?controller=User&action=edit_user&id=<?php echo $_SESSION['user_info']['id'] ?>">修改信息</a></li>
								<li><a href="javascript:void(0);" data-toggle="modal" data-target="#reset-password-modal">修改密码</a></li>
								<li><a href="/PHP/User/logout">注销</a></li>
							</ul>
						</li>
					</ul>
				</div><!--/.nav-collapse -->
		...
		<div class="container">
			<?php require_once './view/'.strtolower($_SESSION['controller']).'/'.$_SESSION['action'].'.html' ?>
		</div><!--/.nav-collapse -->
