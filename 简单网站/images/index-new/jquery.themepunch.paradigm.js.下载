(function (a, b) {
    function m(c, d, e) {
        ...
        c.find(".creative_layer div").each(function (c) {
            ...
            if (e.hasClass("fadeup")) {
                e.animate({top:e.data("_top") + 20 + "px", opacity:0}, {duration:0, queue:false}).delay(d + (f + 1) * 200).animate({top:e.data("_top") + "px", opacity:e.data("_op")}, {duration:300, queue:true});
                f++
            }
            if (e.hasClass("faderight")) {
                e.animate({left:e.data("_left") - 20 + "px", opacity:0}, {duration:0, queue:false}).delay(d + (f + 1) * 200).animate({left:e.data("_left") + "px", opacity:e.data("_op")}, {duration:300, queue:true});
                f++
            }
            ...
            if (e.hasClass("fade")) {
                e.animate({opacity:0}, {duration:0, queue:false}).delay(d + (f + 1) * 200).animate({opacity:e.data("_op")}, {duration:300, queue:true});
                f++
            }
        })
    }
    ...
    function l(c, d) {
        d.cd = 0;
        d.timer = d.timer * 10;
        if (d.thumbStyle == "image" || d.thumbStyle == "both" || d.thumbStyle == "thumb") {
            if (a.browser.msie)c.find(".paradigm_thumb_container #thumbmask .thumbsslide").animate({left:"0px"}, {duration:300, queue:false}); else c.find(".paradigm_thumb_container #thumbmask .thumbsslide").animate({left:"0px"}, {duration:300, queue:false});
            var e = c.find(".paradigm_thumb_container #thumbmask");
            var f = e.find(".thumbsslide");
            var g = c.find(".slide_mainmask");
            setInterval(function () {
                if (d.loaded == 1) {
                    var b = c.data("currentSlide");
                    var h = c.data("currentThumb");
                    if (!e.hasClass("overme") && !g.hasClass("overme") && !g.hasClass("videoon")) {
                        d.cd = d.cd + 1;
                        var i = Math.floor(d.thumbWidth * (d.cd / d.timer));
                        if (a.browser.msie) {
                            h.find("img").animate({left:0 - i + "px"}, {duration:10, queue:false});
                            h.animate({left:i + "px"}, {duration:10, queue:false})
                        } else {
                            h.find("img").animate({left:0 - i + "px"}, {duration:10, queue:false});
                            h.animate({left:i + "px"}, {duration:10, queue:false})
                        }
                        if (d.cd == d.timer) {
                            d.cd = 0;
                            f.find(".paradigm-thumbs").each(function () {
                                var b = a(this);
                                if (a.browser.msie) {
                                    b.stop();
                                    b.find("img").stop(true, true)
                                } else {
                                    b.cssStop(true, true);
                            ...
                            if (b.index() < d.maxitem - 1) {
                                var j = c.find("ul li:eq(" + (b.index() + 1) + ")");
                                k(b, j, c, d);
                                var l = 0 - parseInt(h.parent().css("left"), 0);
                                f.css({position:"absolute"});
                                if (Math.abs(l) <= c.data("thumbnailmaxdif")) {
                                    if (a.browser.msie)f.animate({left:l + "px"}, {duration:300, queue:false}); else f.animate({left:l + "px"}, {duration:300, queue:false})
                                } else {
                                    l = 0 - c.data("thumbnailmaxdif");
                                    if (a.browser.msie)f.animate({left:l + "px"}, {duration:300, queue:false}); else f.animate({left:l + "px"}, {duration:300, queue:false})
                                }
                            } else {
                                k(b, c.find("ul li:first"), c, d);
                                if (a.browser.msie)f.animate({left:"0px"}, {duration:300, queue:false}); else f.animate({left:"0px"}, {duration:300, queue:false})
                            }
                        }
                    }
                }
                                ...
                                if (d.thumbStyle != "none") {
                                    ...
                                    if (f != null && f != b) {
                                        ...
                                        if (Math.abs(j) <= c.data("thumbnailmaxdif")) {
                                            if (a.browser.msie)f.animate({left:j + "px"}, {duration:300, queue:false}); else f.animate({left:j + "px"}, {duration:300, queue:false})
                                        } else {
    ...
    function k(b, c, d, e) {
        ...
        var g = d.find(".slide_mainmask .video_container");
        setTimeout(function () {
            g.remove()
        }, 600);
        ...
        if (i > e.width)c.find("img:first").css({position:"absolute", left:e.width / 2 - i / 2 + "px", width:i + "px", height:j + "px"});
        if (j > e.height)c.find("img:first").css({position:"absolute", top:e.height / 2 - j / 2 + "px", width:i + "px", height:j + "px"});
        if (c.data("transition") == "slide") {
            if (f == false) {
                var l = true;
                if (b.index() > c.index())l = false;
                if (l) {
                    ...
                    c.find(".slide_container").animate({left:"0px", top:"0px", opacity:"1.0"}, {duration:600, queue:false})
                } else {
            ...
            b.find(".slide_container").stop(true, true);
            ...
            c.find(".slide_container").animate({opacity:"1.0"}, {duration:600, queue:false});
        }
        if (d.find(".paradigm_thumb_container").length > 0) {
            ...
            d.find(".paradigm_thumb_container #thumbmask .thumbsslide #thumb" + b.index()).each(function (b) {
                ...
                if (d.attr("id") != "thumb" + c.index()) {
                    ...
                    if (a.browser.msie) {
                        f.animate({left:"0px", height:e.thumbHeight + "px", width:e.thumbWidth + "px"}, {duration:1, queue:false})
                    } else {
                        f.animate({left:"0px", height:e.thumbHeight + "px", width:e.thumbWidth + "px"}, {duration:1, queue:false})
                    }
        ...
        if (d.find(".minithumb").length > 0) {
            var n = d.find("#minithumb" + c.index());
            d.find(".minithumb").removeClass("selected");
            n.addClass("selected");
            if (e.thumbStyle != "both")d.data("currentThumb", n)
        }
    ...
    function i(b, c) {
        ...
        d.mouseenter(function (b) {
            ...
            var h = j(b.pageX, b.pageY, c);
            f.stop();
            g.stop();
            c.addClass("overon");
            f.css({left:parseInt(f.css("left"), 0) + "px", top:parseInt(f.css("top"), 0) + "px"});
            if (a.browser.msie) {
                f.animate({left:0 - h.slideFactorX + "px", top:0 - h.slideFactorY + "px"}, {duration:200, queue:false});
                g.animate({left:0 - h.slideFactorCX + "px", top:0 - h.slideFactorCY + "px"}, {duration:200, queue:false})
            } else {
                f.animate({left:0 - h.slideFactorX + "px", top:0 - h.slideFactorY + "px"}, {duration:200, queue:false});
                g.animate({left:0 - h.slideFactorCX + "px", top:0 - h.slideFactorCY + "px"}, {duration:200, queue:false})
            }
        ...
        d.mouseleave(function (b) {
            ...
            var g = j(a(window).width() / 2, a(window).height / 2, c);
            c.addClass("overon");
            e.stop();
            f.stop();
            if (a.browser.msie) {
                e.animate({left:0 - g.slideFactorX + "px", top:0 - g.slideFactorY + "px"}, {duration:200, queue:false});
                f.animate({left:0 - g.slideFactorCX + "px", top:0 - g.slideFactorCY + "px"}, {duration:200, queue:false})
            } else {
                e.animate({left:0 - g.slideFactorX + "px", top:0 - g.slideFactorY + "px"}, {duration:200, queue:false});
                f.animate({left:0 - g.slideFactorCX + "px", top:0 - g.slideFactorCY + "px"}, {duration:200, queue:false})
            }
            ...
            if (!d.hasClass("overme") && !c.hasClass("overon")) {
                ...
                if (h.y < c.data("maxheight")) {
                    ...
                    if (a.browser.msie) {
                        ...
                        f.animate({left:0 - h.slideFactorX + "px", top:0 - h.slideFactorY + "px"}, {duration:0, queue:false});
                        g.animate({left:0 - h.slideFactorCX + "px", top:0 - h.slideFactorCY + "px"}, {duration:0, queue:false})
                    }
                }
            } else {
                setTimeout(function () {
    ...
    function g(b, c) {
        ...
        b.append('<div class="thumbbuttons"><div class="grainme"><div class="thumbs"></div></div></div>');
    ...
    function f(b, c) {
        var d = b.find("ul >li").length;
        if (d < c.thumbAmount)c.thumbAmount = d;
        ...
        b.append('<div class="paradigm_thumb_container" style="position:absolute;left:' + j + "px;top:" + (c.height + c.padtop + c.padbottom - c.thumbPadding) + "px;width:" + (g + 2) + "px;height:" + (h + 2) + 'px;overflow:hidden"></div>');
        var m = b.find(".paradigm_thumb_container");
        if (c.thumbAmount == 0)m.css({visibility:"hidden"});
        ...
        b.find("ul >li").each(function (e) {
            ...
            var i = g.data("thumb");
            var j = f.find(".slide_container").data("video") == 1;
            ...
            if (a.browser.msie) {
                n.animate({left:"0px", opacity:"0.0", height:c.thumbHeight + "px", width:c.thumbWidth + "px"}, {duration:50, queue:false});
                n.find("img").animate({left:"0px"}, {duration:50, queue:false})
            } else {
                n.animate({left:"0px", opacity:"0.0", height:c.thumbHeight + "px", width:c.thumbWidth + "px"}, {duration:50, queue:false});
                n.find("img").animate({left:"0px"}, {duration:50, queue:false})
            }
            if (j && c.thumbVideoIcon === "on") {
                var p = a('<div class="video"></div>');
                l.append(p);
                l.find(".video").css({position:"absolute", top:c.thumbHeight / 2 + "px", left:c.thumbWidth / 2 + "px", "z-index":"1000"})
            }
            if (c.shadow == "true" || c.shadow == true || c.shadow == "on") {
                var q = a('<div class="paradigm-repeatshadow" style="position:absoluet;margin-left:0px;margin-top:0px;width:' + c.thumbWidth + 'px"></div>');
                l.append(q)
            }
            ...
            r.hover(function () {
                ...
                if (!b.parent().hasClass("selected")) {
                    if (a.browser.msie) {
                        if (a.browser.msie && a.browser.version > 7 && a.browser.version < 9)b.css({display:"block"}); else b.animate({opacity:"1.0"}, {duration:300, queue:false})
                    } else {
                        b.css({left:"0px", display:"block"});
                        b.find("img").css({display:"block", opacity:"1.0", left:"0px"});
                        b.animate({opacity:"1.0"}, {duration:300, queue:false})
                    }
                }
            }, function () {
                var b = a(this).find("#over");
                if (!b.parent().hasClass("selected")) {
                    if (a.browser.msie) {
                        if (a.browser.msie && a.browser.version > 7 && a.browser.version < 9)b.css({display:"none"}); else b.animate({opacity:"0"}, {duration:300, queue:false})
                    } else {
                        b.animate({opacity:"0.0"}, {duration:300, queue:false})
                    }
                }
            });
            r.click(function () {
        ...
        if (e < l) {
            ...
            n.mouseenter(function () {
                var b = a(this);
                if (c.pauseOnRollOverThumbs != "off")b.addClass("overme");
                var d = b.offset();
                ...
                if (g > 0)g = 0;
                if (g < 0 - p)g = 0 - p;
                if (c.pauseOnRollOverMain != "off")b.addClass("overon");
                b.find(".thumbsslide").css({position:"absolute"});
                if (a.browser.msie)b.find(".thumbsslide").animate({left:g + "px"}, {duration:200, queue:false}); else b.find(".thumbsslide").animate({left:g + "px"}, {duration:200, queue:false})
            });
            n.mousemove(function () {
                ...
                if (!b.hasClass("overon")) {
                    b.find(".thumbsslide").css({position:"absolute"});
                    if (a.browser.msie)b.find(".thumbsslide").animate({left:g + "px"}, {duration:0, queue:false}); else b.find(".thumbsslide").animate({left:g + "px"}, {duration:0, queue:false})
                } else {
                    setTimeout(function () {
        ...
        if (c.thumbAmount == 0 || c.thumbStyle == "none") {
            m.css({visibility:"hidden"});
            b.css({width:i + "px"})
        } else {
            b.css({width:i + "px", height:c.height + h + "px"})
        }
    }
    ...
    function e(b, c) {
        if (c.shadow == "true" || c.shadow == true || c.shadow == "on") {
            ...
            if (e > 187)e = 187;
            d = d - 2 * e;
            var f = a('<div class="paradigm-leftshadow" style="top:' + (c.height + c.padtop + c.padbottom) + "px;left:0px;display:none;width:" + e + 'px"></div>');
            var g = a('<div class="paradigm-rightshadow" style="top:' + (c.height + c.padtop + c.padbottom) + 'px;"></div>');
            if (c.thumbStyle === "bullet")var g = a('<div class="paradigm-rightshadow-bullet" style="top:' + (c.height + c.padtop + c.padbottom) + 'px;"></div>');
    ...
    function c(b, c) {
        b.find("ul").wrap('<div class="slide_mainmask" style="z-index:10;position:absolute;top:' + (c.padtop) + "px;left:" + (c.padleft + 1) + "px;width:" + c.width + "px;height:" + c.height + 'px;overflow:hidden"></div>');
        ...
        b.find("ul >li").each(function (d) {
            ...
            e.find(".slide_container .parallax_container .kb_container .video_container").each(function () {
                var d = a(this);
                ...
                e.hover(function () {
                    ...
                    if (a.browser.msie)c.animate({opacity:"0.5"}, {duration:100}); else c.animate({opacity:"0.5"}, {duration:100});
                    ...
                    var b = a(this);
                    var c = b.parent().find(".paradigm-video-overlay");
                    if (a.browser.msie)c.animate({opacity:c.data("origopa")}, {duration:100}); else c.animate({opacity:c.data("origopa")}, {duration:100});
                    if (a.browser.msie && a.browser.version > 7 && a.browser.version < 9) {
                        c.css({display:"none"})
                    }
                });
                e.click(function () {
                    ...
                    d.find(".slide_mainmask").append('<div class="video_container" style="z-index:9999;width:' + c.width + "px;height:" + c.height + 'px">' + b.data("url") + "</div>");
                    var f = d.find(".slide_mainmask .video_container");
    ...
    a.fn.extend({paradigm:function (i) {
        var j = {width:876, height:300, thumbWidth:90, thumbHeight:50, thumbAmount:6, thumbSpaces:4, thumbPadding:4, thumbVideoIcon:"off", thumbStyle:"bullet", bulletXOffset:0, bulletYOffset:0, shadow:"true", parallaxX:200, parallaxY:50, captionParallaxX:50, captionParallaxY:25, timer:2e3, touchenabled:"on"};
        i = a.extend({}, a.fn.paradigm.defaults, i);
        return this.each(function () {
            var j = i;
            if (j.bulletXOffset == b)j.bulletXOffset = 0;
            if (j.bulletYOffset == b)j.bulletYOffset = 0;
            var m = a(this);
            m.find(".video_pradigm").each(function () {
                a(this).addClass("video_container")
            });
            m.find(".video_paradigm_wrap").each(function () {
                a(this).addClass("video_container_wrap")
            });
            ...
            c(m, j);
            e(m, j);
            if (j.thumbStyle == "image" || j.thumbStyle == "both" || j.thumbStyle == "thumb")f(m, j);
            if (j.thumbStyle == "bullet" || j.thumbStyle == "both")g(m, j);
            m.waitForImages(function () {
                h(m, j)
            });
            if (j.timer > 0)l(m, j);
            if (j.touchenabled == "on")m.swipe({data:m, swipeLeft:function () {
                var a = m.data("currentSlide");
                if (a.index() < j.maxitem - 1) {
                    var b = m.find("ul li:eq(" + (a.index() + 1) + ")")
                } else {
                    var b = m.find("ul li:first")
                }
                k(a, b, m, j)
            }, swipeRight:function () {
                var a = m.data("currentSlide");
                if (a.index() > 0) {
                    ...
                    var b = m.find("ul li:eq(" + (j.maxitem - 1) + ")")
                }
                k(a, b, m, j)
